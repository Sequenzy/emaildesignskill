...
const required = [
  ...
  "public/skills/emaildesignskill/SKILL.md",
  "public/.well-known/skills/emaildesignskill/SKILL.md",
  "public/.well-known/agent-skills/emaildesignskill/SKILL.md",
...
if (!markdown.includes("npx skills add emaildesignskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "emaildesignskill") throw new Error("Invalid well-known skills index");
